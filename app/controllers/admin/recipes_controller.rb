class Admin::RecipesController < AdminController
  ...
  private
    ...
    def recipe_params
      params.require(:recipe).permit(:tag, :color, :premium, :photo, :title, :nutrition_info, :short_description, :description, :how_to_cook, :difficulty, :serving, :url, :recipe_category_id, :cook_id, recipe_ingredients_attributes: [:id, :amount, :unit_id, :_destroy, :ingredient_id, :description, :amount_description])
    end
end
